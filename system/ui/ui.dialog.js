...
;(function($) {
    ...
    // oxygenos edit: create minimize object and functionality
    uiDialogTitlebar.append('<a href="#" class="ui-dialog-titlebar-minimize"><span>_</span></a>');
		this.uiDialogTitlebarMinimize = $('.ui-dialog-titlebar-minimize', uiDialogTitlebar)
			.hover(function() { $(this).addClass('ui-dialog-titlebar-minimize-hover'); }, 
			       function() { $(this).removeClass('ui-dialog-titlebar-minimize-hover'); })
		...
		this.activate = function() {
			...
			// oxygenos edit
			$(".ui-dialog").css("opacity", 0.55);
			uiDialog.css("opacity", 1);			
			//uiDialog.fadeTo("fast", 0.88);
			
			// OXYGENOS EDIT: MAKES "ACTIVATE" PUBLIC
			// CALLBACK: activate
			var closeEV = null;
			var closeUI = {
				options: options
			};
			$(this.element).triggerHandler("dialogactivate", [closeEV, closeUI], options.activate);			
		};
