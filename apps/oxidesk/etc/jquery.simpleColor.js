...
$.fn.simpleColor = function(options) {
	...
	function buildSelector(index) {
		...
		var display_box = $("<div class='simpleColorDisplay' style='float: left; margin-right: 2px' />");
		...
		var select_button = $("<input type='button' style='float: left' value='Selectare'" + 
							  " class='simpleColorSelectButton "+options.buttonClass+"'>");
		container.append(select_button);
		
		// Create the cancel button
		var cancel_button = $("<input type='button' value='Anuleaza'" + 
		...
		select_button.bind('click', {
			...
			function (event) {
				...
				// Build the chooser
					...
					var chooser = $("<div class='simpleColorChooser' style='float:left' />");
					chooser.css('border',  options.border);
					chooser.css('margin',  '0px');
					chooser.css('margin-top',  '3px');
					chooser.css('margin-left',  '170px');
